...
JSClass  *js_IAPAlipay_class;
JSObject *js_IAPAlipay_prototype;
...
void js_IAPAlipay_finalize(JSFreeOp *fop, JSObject *obj) {
//#ifdef COCOS2D_JAVASCRIPT
	LOGD("js_IAPAlipay_finalize\n");
    js_proxy_t* nproxy;
    js_proxy_t* jsproxy;
...
void js_register_pluginx_alipay_IAPAlipay(JSContext *cx, JSObject *global) {
	js_IAPAlipay_class = (JSClass *)calloc(1, sizeof(JSClass));
	js_IAPAlipay_class->name = "IAPAlipay";
	js_IAPAlipay_class->addProperty = JS_PropertyStub;
	js_IAPAlipay_class->delProperty = JS_PropertyStub;
	js_IAPAlipay_class->getProperty = JS_PropertyStub;
	js_IAPAlipay_class->setProperty = JS_StrictPropertyStub;
	js_IAPAlipay_class->enumerate = JS_EnumerateStub;
	js_IAPAlipay_class->resolve = JS_ResolveStub;
	js_IAPAlipay_class->convert = JS_ConvertStub;
	js_IAPAlipay_class->finalize = js_IAPAlipay_finalize;
	js_IAPAlipay_class->flags = JSCLASS_HAS_RESERVED_SLOTS(2);

	JSPropertySpec *properties = NULL;

	static JSFunctionSpec funcs[] = {
		JS_FN("getPluginName", js_IAPAlipay_getPluginName, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getPluginVersion", js_IAPAlipay_getPluginVersion, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("init", js_IAPAlipay_init, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("initDeveloperInfo", js_IAPAlipay_initDeveloperInfo, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("payForProduct", js_IAPAlipay_payForProduct, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getSDKVersion", js_IAPAlipay_getSDKVersion, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setDebugMode", js_IAPAlipay_setDebugMode, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};

	JSFunctionSpec *st_funcs = NULL;

	js_IAPAlipay_prototype = JS_InitClass(
		cx, global,
	...
	if (!p) {
		...
		p->type = typeId;
		p->jsclass = js_IAPAlipay_class;
		p->proto = js_IAPAlipay_prototype;
