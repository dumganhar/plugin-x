...
JSClass  *js_AnalyticsFlurry_class;
JSObject *js_AnalyticsFlurry_prototype;
...
void js_AnalyticsFlurry_finalize(JSFreeOp *fop, JSObject *obj) {
	LOGD("js_AnalyticsFlurry_finalize\n");
    js_proxy_t* nproxy;
    js_proxy_t* jsproxy;
...
void js_register_pluginx_flurry_AnalyticsFlurry(JSContext *cx, JSObject *global) {
	js_AnalyticsFlurry_class = (JSClass *)calloc(1, sizeof(JSClass));
	js_AnalyticsFlurry_class->name = "AnalyticsFlurry";
	js_AnalyticsFlurry_class->addProperty = JS_PropertyStub;
	js_AnalyticsFlurry_class->delProperty = JS_PropertyStub;
	js_AnalyticsFlurry_class->getProperty = JS_PropertyStub;
	js_AnalyticsFlurry_class->setProperty = JS_StrictPropertyStub;
	js_AnalyticsFlurry_class->enumerate = JS_EnumerateStub;
	js_AnalyticsFlurry_class->resolve = JS_ResolveStub;
	js_AnalyticsFlurry_class->convert = JS_ConvertStub;
	js_AnalyticsFlurry_class->finalize = js_AnalyticsFlurry_finalize;
	js_AnalyticsFlurry_class->flags = JSCLASS_HAS_RESERVED_SLOTS(2);

	JSPropertySpec *properties = NULL;

	static JSFunctionSpec funcs[] = {
		JS_FN("logTimedEventBegin", js_AnalyticsFlurry_logTimedEventBegin, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setUserId", js_AnalyticsFlurry_setUserId, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("logError", js_AnalyticsFlurry_logError, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setCaptureUncaughtException", js_AnalyticsFlurry_setCaptureUncaughtException, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setGender", js_AnalyticsFlurry_setGender, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("logPageView", js_AnalyticsFlurry_logPageView, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getPluginName", js_AnalyticsFlurry_getPluginName, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setReportLocation", js_AnalyticsFlurry_setReportLocation, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getPluginVersion", js_AnalyticsFlurry_getPluginVersion, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("logEvent", js_AnalyticsFlurry_logEvent, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setSessionContinueMillis", js_AnalyticsFlurry_setSessionContinueMillis, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setAge", js_AnalyticsFlurry_setAge, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("init", js_AnalyticsFlurry_init, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setVersionName", js_AnalyticsFlurry_setVersionName, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("startSession", js_AnalyticsFlurry_startSession, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("stopSession", js_AnalyticsFlurry_stopSession, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setUseHttps", js_AnalyticsFlurry_setUseHttps, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("logTimedEventEnd", js_AnalyticsFlurry_logTimedEventEnd, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getSDKVersion", js_AnalyticsFlurry_getSDKVersion, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setDebugMode", js_AnalyticsFlurry_setDebugMode, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};

	JSFunctionSpec *st_funcs = NULL;

	js_AnalyticsFlurry_prototype = JS_InitClass(
		cx, global,
		js_ProtocolAnalytics_prototype,
		js_AnalyticsFlurry_class,
		empty_constructor, 0,
		properties,
		funcs,
	...
	if (!p) {
		...
		p->type = typeId;
		p->jsclass = js_AnalyticsFlurry_class;
		p->proto = js_AnalyticsFlurry_prototype;
