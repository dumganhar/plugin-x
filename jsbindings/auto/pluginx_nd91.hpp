...
extern JSClass  *js_IAPNd91_class;
extern JSObject *js_IAPNd91_prototype;

JSBool js_IAPNd91_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_IAPNd91_finalize(JSContext *cx, JSObject *obj);
