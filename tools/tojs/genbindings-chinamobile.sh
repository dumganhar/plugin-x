...
# Generate bindings for plugin-x chinamobile
echo "Generating bindings for plugin-x chinamobile..."
set -x
LD_LIBRARY_PATH=${CLANG_ROOT}/lib $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${PLUGINX_ROOT}/chinamobile/jsb_chinamobile.ini -s chinamobile -o $PLUGINX_ROOT/jsbindings/auto
