...
# Generate bindings for plugin-x chinatelecom
echo "Generating bindings for plugin-x chinatelecom..."
set -x
LD_LIBRARY_PATH=${CLANG_ROOT}/lib $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${PLUGINX_ROOT}/chinatelecom/jsb_chinatelecom.ini -s chinatelecom -o $PLUGINX_ROOT/jsbindings/auto
