...
# Generate bindings for plugin-x chinaunicom
echo "Generating bindings for plugin-x chinaunicom..."
set -x
LD_LIBRARY_PATH=${CLANG_ROOT}/lib $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${PLUGINX_ROOT}/chinaunicom/jsb_chinaunicom.ini -s chinaunicom -o $PLUGINX_ROOT/jsbindings/auto
