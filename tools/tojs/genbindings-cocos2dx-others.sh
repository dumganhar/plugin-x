...
set -x
LD_LIBRARY_PATH=${CLANG_ROOT}/lib $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${PLUGINX_ROOT}/tools/tojs/jsb_cocos2dx_others.ini -s cocos2dx_other -o $PLUGINX_ROOT/jsbindings/auto
