...
# Generate bindings for plugin-x flurry
echo "Generating bindings for plugin-x flurry..."
set -x
LD_LIBRARY_PATH=${CLANG_ROOT}/lib $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${PLUGINX_ROOT}/flurry/jsb_flurry.ini -s flurry -o $PLUGINX_ROOT/jsbindings/auto
