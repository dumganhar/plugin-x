...
# Generate bindings for plugin-x nd91
echo "Generating bindings for plugin-x nd91..."
set -x
LD_LIBRARY_PATH=${CLANG_ROOT}/lib $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${PLUGINX_ROOT}/nd91/jsb_nd91.ini -s nd91 -o $PLUGINX_ROOT/jsbindings/auto
