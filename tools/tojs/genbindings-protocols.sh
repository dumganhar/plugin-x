...
# Generate bindings for plugin-x protocols
echo "Generating bindings for plugin-x protocols..."
set -x
LD_LIBRARY_PATH=${CLANG_ROOT}/lib $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${PLUGINX_ROOT}/protocols/jsb_protocols.ini -s protocols -o $PLUGINX_ROOT/jsbindings/auto
