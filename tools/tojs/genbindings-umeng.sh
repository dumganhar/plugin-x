...
# Generate bindings for plugin-x umeng
echo "Generating bindings for plugin-x umeng..."
set -x
LD_LIBRARY_PATH=${CLANG_ROOT}/lib $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${PLUGINX_ROOT}/umeng/jsb_umeng.ini -s umeng -o $PLUGINX_ROOT/jsbindings/auto
